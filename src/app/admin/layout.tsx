...
const navItems = [
  ...
  {
    href: "/admin/verify",
    k: "dash.admin.nav.verify",
    icon: ShieldCheck,
    tone: { bg: "bg-amber-500/15", text: "text-amber-700 dark:text-amber-300" },
  },
  {
    href: "/admin/transfer",
    k: "dash.admin.nav.transfer",
    icon: Send,
    tone: { bg: "bg-sky-500/15", text: "text-sky-600 dark:text-sky-300" },
  },
  {
    href: "/admin/wallet",
    k: "dash.admin.nav.wallet",
    icon: WalletIcon,
    tone: { bg: "bg-rose-500/15", text: "text-rose-600 dark:text-rose-300" },
  },
  {
    href: "/admin/payouts",
    k: "dash.admin.nav.payouts",
    icon: Banknote,
    tone: { bg: "bg-teal-500/15", text: "text-teal-600 dark:text-teal-300" },
  },
  {
    href: "/admin/earn-online",
    k: "dash.admin.nav.earn_online",
    icon: Globe,
    tone: { bg: "bg-sky-500/15", text: "text-sky-600 dark:text-sky-300" },
  },
  {
    href: "/admin/observer-applications",
    k: "dash.admin.nav.observer_apps",
    icon: ClipboardList,
    tone: {
      bg: "bg-indigo-500/15",
