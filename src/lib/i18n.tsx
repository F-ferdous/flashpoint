...
const translations = {
  bn: {
    ...
    gesa: {
      ...
      about_pill_tech: "প্রযুক্তি",
      projects_title: "আমাদের ৭টি মূল প্রজেক্ট",
      p1: "শিখুন এবং আয়",
      p1_desc: "সহজে শিখুন ও আয়ের সুযোগ।",
      p2: "হেলথ এন্ড ওয়েলনেস",
      p2_desc: "স্বাস্থ্যকর ও পরিপূর্ণ জীবনের সহযোগী।",
      p3: "গবেষণ",
      p3_desc: "গবেষণা মাধ্যমে সমাধান ও বাস্তবায়ন।",
      p4: "এন্ট্রাপ্রেনার ডেভেলপমেন্ট",
      p4_desc: "নতুন উদ্যোক্তা তৈরির সহায়তা।",
      p5: "কমিউনিটি এনগেজমেন্ট",
      p5_desc: "সামাজিক সচেতনতা ও কমিউনিটি কাজ।",
      p6: "সফট স্কিল ডেভেলপমেন্ট",
      p6_desc: "লিডারশিপ, যোগাযোগ ও ব্যক্তিগত দক্ষতা।",
      p7: "আইসিটি ও এআই",
    ...
    navbar: {
      aria_home: "ফ্ল্যাশ সার্ভিসেস এজেন্সি হোম",
      logout: "লগ আউট",
      login: "লগ ইন",
      get_started: "শুরু করুন",
    ...
    footer: {
      ...
      blurb1:
        "ফ্ল্যাশ সার্ভিসেস এজেন্সি একত্র করে রিওয়ার্ডস, পেমেন্টস ও কেয়ার। অফারে আয় করুন, নিশ্চিন্তে রিডিম করুন, এবং একই নিরাপদ প্ল্যাটফর্মে টেলিমেডিসিন নিন।",
      blurb2:
        "আধুনিক টিম ও কমিউনিটির জন্য— প্রাইভেসি-ফার্স্ট, স্কেলেবল ও ব্যবহারবান্ধব।",
      rights: "© {year} ফ্ল্যাশ সার্ভিসেস এজেন্সি। সর্বস্বত্ব সংরক্ষিত।",
  ...
  en: {
    ...
    gesa: {
      ...
      hero_cta_secondary: "See Roadmap",
      about_title: "Who We Are",
      about_desc:
        "GESA Flash builds for Bangladesh — advancing education, health, entrepreneurship and tech awareness to create positive social impact.",
      about_pill_education: "Education",
      about_pill_health: "Health",
      about_pill_entre: "Entrepreneurship",
      about_pill_tech: "Technology",
      projects_title: "Our 7 Core Projects",
      p1: "Learn & Earn",
      p1_desc: "Learn easily and unlock earning opportunities.",
      p2: "Health & Wellness",
      p2_desc: "Support for a healthy, fulfilled life.",
      p3: "Research",
      p3_desc: "Solutions through research and implementation.",
      p4: "Entrepreneur Development",
      p4_desc: "Support to create new entrepreneurs.",
      p5: "Community Engagement",
      p5_desc: "Awareness and community‑driven work.",
      p6: "Soft Skills Development",
      p6_desc: "Leadership, communication and personal skills.",
      p7: "ICT & AI",
    ...
    footer: {
      ...
      blurb1:
        "Flash Services Agency unifies rewards, payments, and care. Earn through offers, redeem with confidence, and access telemedicine from a single, secure platform.",
      blurb2:
        "Built for modern teams and communities — privacy‑first, scalable, and delightful to use.",
      rights: "© {year} Flash Services Agency. All rights reserved.",
